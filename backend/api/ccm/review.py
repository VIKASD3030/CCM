...
async def approve_draft(
    ...
    """Approve a draft response. Only admins can approve."""
    try:
...
async def reject_draft(
    ...
    """Reject a draft with feedback for revision. Only admins can reject."""
    try:
...
async def mark_as_sent(
    ...
    """Mark an approved draft as sent. Only admins can send."""
    try:
...
async def archive_letter(
    ...
    """Archive a letter and all its drafts. Only admins can archive."""
    try:
